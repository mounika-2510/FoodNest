...
/*
Why use `new URL()` for images?

- Sometimes bundlers (like Parcel) fail to resolve image imports
  when using `import logo from "./logo.png"`,
  especially with CommonJS or cache issues.
- `new URL("./logo.png", import.meta.url).href`
  tells the bundler clearly that this is a static asset file.
- This guarantees a correct browser-ready URL for the image.

Used when image import works in code but shows broken image in UI.
*/
